package com.bjut.cyl.kfyrip.view;
...
public class PopupMenu extends PopupWindow implements OnClickListener {
	...
	public PopupMenu(Activity activity) {
		...
		collectBtn = (Button) popView.findViewById(R.id.collect);
		collectTv = (TextView) popView.findViewById(R.id.tv_collect);
	...
	public void changeImg(int id){
		if (id == 0){
			collectBtn.setBackgroundResource(R.drawable.collect);
			collectTv.setText("收藏");
		}else if (id == 1){
			collectBtn.setBackgroundResource(R.drawable.collect_click);
