...
public class NewsCommentListActivity extends DialogShowOffAct implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mData.size() == 0) {
			getCommentList(messageId, ConfigUtil.CHANNEL_ID_NEWS, "0");
		}
		...
		commentListView
				.setOnRefreshListener(new OnRefreshListener2<ListView>() {
					...
					public void onPullUpToRefresh(
							PullToRefreshBase<ListView> refreshView) {
						offset = offset + 10;
						getCommentList(messageId, ConfigUtil.CHANNEL_ID_NEWS, String.valueOf(offset));
						mAdapter.notifyDataSetChanged();
						new FinishRefresh().execute();
	...
	public void onClick(View v) {
		...
		case R.id.ivTitleBtnLeft:
			...
			break;
		case R.id.ll_write:
			LayoutInflater inflater=LayoutInflater.from(NewsCommentListActivity.this);
			commentDialog= new CommentDialog(NewsCommentListActivity.this, "评论") {
				...
				public void clickOkCallBack() {
					...
					if (!content.isEmpty()){
						...
						intent.setClass(NewsCommentListActivity.this,
								NotiCommentListActivity.class);
						intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
						startActivity(intent);
						commentDialog.dismiss();
					}else {
						PromptUtil.showToast("评论内容不能为空！");
					}
