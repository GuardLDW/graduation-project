...
public class BaoJiangActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baojiang);

        ivTitleBtnLeft = (ImageButton) findViewById(R.id.ivTitleBtnLeft);
        iv = (PhotoView) findViewById(R.id.baojiang);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            String picture = photo.result.get(2).picture;
                            //System.out.println("ooooooooooo"+picture);
                            Glide.with(BaoJiangActivity.this).load("http://resass.bjut.edu.cn/resass/" + picture).asBitmap().into(iv);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
